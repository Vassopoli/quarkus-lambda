...
#FUNCTION_NAME=PocLambdaNative
FUNCTION_NAME=PocLambdaNativeNative
HANDLER=com.alivassopoli.lambda.GreetingLambda::handleRequest
RUNTIME=java11
ZIP_FILE=fileb://C:/Users/noble/Projects/poc-lambda-native/target/function.zip
